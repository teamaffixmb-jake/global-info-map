 ...
 */
export function getEarthquakeSeverity(magnitude) {
 ...
 */
export function getVolcanicSeverity(alertLevel) {
 ...
 */
export function getHurricaneSeverity(category) {
 ...
 */
export function getTornadoSeverity(intensity) {
 ...
 */
export function getAuroraSeverity(kpIndex) {
 ...
 */
export function getRocketLaunchSeverity() {
 ...
 */
export function getConflictSeverity(intensity) {
 ...
 * Based on size
 */
export function getProtestSeverity(size) {
 ...
 */
export function getSocialUnrestSeverity(severity) {
 ...
 */
export function getDiseaseSeverity(severity, cases) {
    const level = severity.toLowerCase();
 ...
 */
export function getISSSeverity() {
    return SEVERITY.LOW;
}
 ...
 * Based on wind speed
 */
export function getWindSeverity(speed) {
 ...
 * Based on intensity
 */
export function getPrecipitationSeverity(intensity) {
